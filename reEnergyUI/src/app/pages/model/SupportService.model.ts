import { QuestionProperty } from './hospital/QuestionProperty.model';
import { StaffDetailsQuestionProperty } from './hospital/humanResource.model';
...
export class SupportService
{
      non_clinical_and_administrative_departments_of_the_organization:NonClinicalServiceList=new NonClinicalServiceList()
       ...
       imaging_service_list :ServiceList[]=[]
       ...
       hospital_according_to_aerb_pcpndt_guidelines :QuestionProperty=new QuestionProperty();
     ...
     number_of_ambulance :QuestionPropertySupportServc=new QuestionPropertySupportServc();
      ...
      ambulance_appropriately_equipped_have_basic_life_support:QuestionProperty 
      concerned_personnel_trained_basic_cardiopulmonary_resuscitation :QuestionProperty
      ...
      hospital_has_pharmacy_medical_store_facility :QuestionPropertySupportServc=new QuestionPropertySupportServc();
      pharmacy_licence:PharmacyLicience=new PharmacyLicience();
      pharmacy_service_list:ServiceList[]=[];
