export class GeneralForm {
  ...
  splitLocation = new Array<SplitLocation>();
...
//new class
export class GeneralinfoSection {
  basicCertification = new BasicCertification();
...
// export class Certificationcoordinator {
//   cerco_org_spoc_name: string;
//   cerco_org_head_desig: string;
//   cerco_org_head_email: string;
//   cerco_org_head_no: string;
// }

export class SplitLocation {
  id: number;
  ...
  district_list:District=new District()
}
class District {
  id: number;
  districtname: string;
...
export class GeneralInfo {
  ...
  spoc_email: string;
  organizationhead = new Organizationhead();
  // certificationcoordinator = new Certificationcoordinator();
  location = new Location();
}

export class OrganizationIsAlreadyEmpanelledWith {
  cghs: boolean;
  cghs_url: string;
  railways: boolean;
  railways_url: string;
...
export class OrganizationInformation {
  ...
  organization_is_already_empanelled_with = new OrganizationIsAlreadyEmpanelledWith();
}


export class GeneralinfoSectionQuestionBank {
