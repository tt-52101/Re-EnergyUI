...
import { CenQualityCare } from '../../../../../model/center/CenQualityCare.model';
...
@Component({
  selector: 'app-cen-qualitycare',
  templateUrl: './cen-qualitycare.component.html',
  styleUrls: ['./cen-qualitycare.component.scss', '../../central.component.scss']
})
export class CenQualitycareComponent implements OnInit {
  openById = {};
  cenhospitalPages: cenHospitalPages;
  cenhospitalPagesQueBank: cenHospitalPagesQuestionBank;
  cenqualitycare: CenQualityCare;
  public currentObj: any;
  public propertyname: any;
  public selectedFile: any;
  cenqualitycareSubmitted = false;
  ary_uploadedDocs: FileViewOrDelete[] = new Array();
  @Output() deleteFile = new EventEmitter();
  @ViewChild('acc') accordion: NgbAccordion;
  @ViewChild('cenqualitycareform', { static: false }) cenqualitycareform: NgForm;
  Stage_id: number;
  ...
  constructor(private cenhospdataserv: cenHospitalDataShareService, private hospdataserv: HospitalDataShareService, private uploadService: FileUploadService, private tostr: CustomTosterServiceService, private modalService: NgbModal) {
    ...
    this.cenqualitycare = new CenQualityCare();
    ...
    this.cenhospdataserv.getData().subscribe(data => {
      ...
      if (data != null || data != undefined) {
        ...
        this.cenqualitycare = data.cenqualitycare;
      }
    ...
    this.cenhospdataserv.getFormSubmissionStatus().subscribe(data => {
      ...
      if (data != null || data != undefined) {
        ...
        this.cenqualitycareSubmitted = data;
