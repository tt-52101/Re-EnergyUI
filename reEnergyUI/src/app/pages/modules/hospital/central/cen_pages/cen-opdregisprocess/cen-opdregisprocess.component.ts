...
import { cenHospitalPages, cenHospitalPagesQuestionBank } from '../../../../../model/center/cenHospitalPages.model';
import { CenOpdRegisProcess } from '../../../../../model/center/CenOpdRegisProcess.model';
...
@Component({
  selector: 'app-cen-opdregisprocess',
  templateUrl: './cen-opdregisprocess.component.html',
  styleUrls: ['./cen-opdregisprocess.component.scss', '../../central.component.scss']
})
export class CenOpdregisprocessComponent implements OnInit {
  openById = {}
  cenhospitalPages: cenHospitalPages;
  cenhospitalPagesQueBank: cenHospitalPagesQuestionBank;
  cenopdregispro: CenOpdRegisProcess;
  public currentObj: any;
  public propertyname: any;
  public selectedFile: any;
  cenopdregisformSubmitted = false;
  ary_uploadedDocs: FileViewOrDelete[] = new Array();
  @Output() deleteFile = new EventEmitter();
  @ViewChild('acc') accordion: NgbAccordion;
  @ViewChild('cenopdregisform', { static: false }) cenopdregisform: NgForm;
  Stage_id: number;
  ...
  constructor(private cenhospdataserv: cenHospitalDataShareService, private hospdataserv: HospitalDataShareService, private uploadService: FileUploadService,
    ...
    this.cenopdregispro = new CenOpdRegisProcess();
    ...
    this.cenhospdataserv.getData().subscribe(data => {
      ...
      if (data != null || data != undefined) {
        ...
        this.cenopdregispro = data.cenopdregispro;
      }
    ...
    this.cenhospdataserv.getFormSubmissionStatus().subscribe(data => {
      ...
      if (data != null || data != undefined) {
        ...
        this.cenopdregisformSubmitted = data;
