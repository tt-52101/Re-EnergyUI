...
import { AdmissionDischarge } from 'src/app/pages/model/hospital/AdmissionDischarge.model';
...
@Component({
  ...
  styleUrls: ['./admission-discharge.component.scss', '../../hospital.component.scss']
})
export class AdmissionDischargeComponent implements OnInit {
  ...
  admsn_dischrge: AdmissionDischarge;
  public currentObj: any;
  public propertyname: any;
  public selectedFile: any;
  admsndischrgeformSubmitted = false;
  ary_uploadedDocs: FileViewOrDelete[] = new Array();
  @ViewChild('admissiondisform', { static: false }) admissiondisform: NgForm;
  @ViewChild('acc') accordion: NgbAccordion;
  @Output() deleteFile = new EventEmitter();
  @Output() openNcModelAdmsnControl = new EventEmitter();
  ncFormTabInfo: any;
  currentUser: any;
  ...
  constructor(private hospdataserv: HospitalDataShareService, private uploadService: FileUploadService,
    ...
    this.admsn_dischrge = new AdmissionDischarge();
    ...
    this.hospdataserv.getData().subscribe(data => {
      ...
      if (data != null || data != undefined) {
        ...
        this.admsn_dischrge = this.hospitalPages.admsn_dischrge;
    ...
    this.hospdataserv.getFormSubmissionStatus().subscribe(data => {
      ...
      if (data != null || data != undefined) {
        ...
        this.admsndischrgeformSubmitted = data;
  ...
  openNcModel(objName, propName, quesObj: any) {
    ...
    this.openNcModelAdmsnControl.emit({ ObjName: objName, propName: propName, quesObj })
