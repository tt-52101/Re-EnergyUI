...
@Pipe({
  name: 'OANcbtnColorPipe'
})
export class OaNcbtnColorPipe implements PipeTransform {
  ...
  transform(value: any, args?: any): any {
    ...
    let clsApply = {
      ...
      'btn-warning': value.ncstage == 3 ? true : false,
      'btn-success': value.ncstage == 2 ? true : false,
    }
